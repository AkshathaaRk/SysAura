...
const Reports: React.FC = () => {
  ...
  useEffect(() => {
    const loadReports = () => {
      ...
      const savedScheduledReports = localStorage.getItem('sysaura_scheduled_reports');
  ...
  const getTimeFrameLabel = (timeFrame: ReportTimeFrame) => {
    switch (timeFrame) {
      case '1h':
        return 'Last Hour';
      case '4h':
  ...
  const handleScheduleReport = () => {
    ...
    try {
      ...
      localStorage.setItem('sysaura_scheduled_reports', JSON.stringify(updatedScheduledReports));
    ...
    <div className="h-full">
      <div className="mb-6">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm">
          Generate and schedule system performance reports
        </p>
      </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <div className="relative">
                        <button
                          type="button"
                          className="relative w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                          onClick={() => {
                        ...
                        {isTimeFrameOpen && (
                          <div className="absolute z-10 mt-1 w-full bg-white dark:bg-gray-700 shadow-lg rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                            {(['1h', '4h', '12h', '1d', '1w', '1m'] as ReportTimeFrame[]).map((timeFrame) => (
                              <div
                                key={timeFrame}
                                className={`cursor-default select-none relative py-2 pl-3 pr-9 hover:bg-gray-100 dark:hover:bg-gray-600 ${
                                  selectedTimeFrame === timeFrame ? 'bg-gray-100 dark:bg-gray-600' : ''
                                }`}
                                onClick={() => {
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        {isFormatOpen && (
                          <div className="absolute z-10 mt-1 w-full bg-white dark:bg-gray-700 shadow-lg rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                            {(['pdf', 'txt'] as ReportFormat[]).map((format) => (
                              <div
                                key={format}
                                className={`cursor-default select-none relative py-2 pl-3 pr-9 hover:bg-gray-100 dark:hover:bg-gray-600 ${
                                  selectedFormat === format ? 'bg-gray-100 dark:bg-gray-600' : ''
                                }`}
                                onClick={() => {
                  ...
                  <div className="mb-6">
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="includeAllSystems" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                        Include data from all connected systems
                      </label>
                    </div>
                  </div>
