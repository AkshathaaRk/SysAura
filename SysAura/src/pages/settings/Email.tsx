...
const EmailSettings: React.FC = () => {
  ...
  useEffect(() => {
    // In a real application, you would fetch the user's email from your backend
    // For this demo, we'll simulate getting the email from localStorage
    ...
    <div className="container mx-auto max-w-3xl py-6">
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Update your email address</p>
        </div>
